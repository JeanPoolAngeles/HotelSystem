...
<body>
    <main class="main-content mt-0">
        <div class="page-header align-items-start min-vh-100" style="background-image: url('{{ asset('img/fondohotel.jpeg') }}');">
                    ...
                    <div class="col-lg-4 col-md-8 col-12 mx-auto">
                        <div class="card z-index-0 fadeIn3 fadeInBottom">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-success shadow-primary border-radius-lg py-3">
                            ...
                            <div class="card-body">
                                ...
                                <form action="/login" method="POST" role="form" class="text-start">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn bg-gradient-success w-100 my-4 mb-2">Iniciar Sesión</button>
                                    </div>
                                </form>
                            </div>
                        </div>
