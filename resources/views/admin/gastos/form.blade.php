<div class="box box-info padding-1">
    <div class="box-body row">
        <div class="form-group col-md-3">
            {{ Form::label('monto') }}
            {{ Form::number('monto', $gasto->monto ?? '', ['class' => 'form-control' . ($errors->has('monto') ? ' is-invalid' : ''), 'placeholder' => 'Monto' , 'step' => '0.01', 'min' => '0.01']) }}
    ...
    <div class="box-footer mt20 text-right">
        <a href="{{ route('admin.gastos.index') }}" class="btn btn-danger">{{ __('Cancel') }}</a>
