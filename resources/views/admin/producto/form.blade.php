<div class="box box-info padding-1">
    <div class="box-body row">        
        ...
        <div class="form-group col-md-5">
            {{ Form::label('producto') }}
            {{ Form::text('producto', $producto->producto, ['class' => 'form-control' . ($errors->has('producto') ? ' is-invalid' : ''), 'placeholder' => 'Nombre del Producto']) }}
        ...
        <div class="form-group col-md-4">
            ...
            {{ Form::text('stock', $producto->stock, [
                ...
                'placeholder' => 'Stock',
                $producto->exists ? 'disabled' : ''
            ]) }}
            {{ Form::hidden('stock_hidden', $producto->stock, ['id' => 'stock_hidden']) }}
    ...
    <div class="box-footer mt20 text-right">
        <a href="{{ route('admin.productos.index') }}" class="btn btn-danger">{{ __('Cancel') }}</a>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const stockHiddenField = document.querySelector('input[name="stock_hidden"]');

        if (stockField.hasAttribute('disabled')) {
            stockHiddenField.value = stockField.value;
        }
    });
</script>