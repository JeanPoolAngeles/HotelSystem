...
class CotizacionController extends Controller
{
    ...
    public function ticket($id)
    {
        ...
        $data['cotizacion'] = Cotizacion::join('cliente', 'cotizaciones.id_cliente', '=', 'cliente.id')
            ->select('cotizaciones.*', 'cliente.nombre', 'cliente.telefono', 'cliente.direccion')
        ...
        $html = View::make('admin.cotizacion.ticket', $data)->render();
