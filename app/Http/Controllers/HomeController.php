...
class HomeController extends Controller
{
    public function index(){
        ...
        $ventasTotal = Venta::whereIn('estado', [1, 2])->sum('total');
        $montosTotal = [
        ...
        $productos = Producto::where('stock', '<=', 5)->limit(12)->get();

        return view('panel.dashboard', compact('ventas', 'productos', 'compras', 'ventasPorSemana', 'comprasPorSemana', 'totales', 'montosTotal'));
    }
}
