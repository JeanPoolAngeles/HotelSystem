...
class CompraController extends Controller
{
    ...
    public function ticket($id)
    {
        ...
        $html = View::make('admin.compra.ticket', $data)->render();
    ...
    public function anular($compraId)
    {
        ...
        if ($existe) {
            try {
                ...
                return redirect()->route('admin.compra.show')
    ...
    public function generatePdfReport()
    {
        ...
        // Generar el contenido del ticket en HTML
        $html = View::make('admin.compra.reporte', $data)->render();
